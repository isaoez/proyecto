...
urlpatterns = [
    ...
    path('trueque/aceptar/<int:trueque_id>/', views.aceptar_trueque_cadena, name='aceptar_trueque_cadena'),
    path('trueque/rechazar/<int:trueque_id>/', views.rechazar_trueque_cadena, name='rechazar_trueque_cadena'),
